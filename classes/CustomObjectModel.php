...
class TerritoryCustomObjectModel extends ObjectModel
{
    /**
    ...
    public function createDatabase()
    {
        ...
        foreach ($definition['relation_tables'] as $table_name) {
            $sql = 'ALTER TABLE ' . _DB_PREFIX_ . $table_name . ' ADD COLUMN ' . $definition['primary'] . ' INTEGER';
            Db::getInstance()->execute($sql);
        }
    }
    ...
    public function dropDatabase()
    {
        ...
        foreach ($definition['relation_tables'] as $table_name) {
            $sql = 'ALTER TABLE ' . _DB_PREFIX_ . $table_name . ' DROP COLUMN ' . $definition['primary'];
            Db::getInstance()->execute($sql);
        }
